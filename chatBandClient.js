class ChatBandClient {
    ...
    bassFiles = [
        ...
        "Contra 3/Bass.mp3",
        "Earthbound/Hospital (Bass 1).mp3",
        "Earthbound/Hospital (Bass 2).mp3",
        "Earthbound/Your Name Please (Bass).mp3",
        "F-Zero/Bass.mp3",
        ...
        "Sonic 2/Mystic Cave Zone (Bass 2).mp3",
    ...
    guitarFiles = [
        ...
        "Donkey Kong Country 2/Guitar.mp3",
        "Earthbound/Buy Somethin Will Ya (Guitar 1).mp3",
        "Earthbound/Buy Somethin Will Ya (Guitar 2).mp3",
        "Earthbound/Sunrise Onett (Guitar 1).mp3",
        "Earthbound/Sunrise Onett (Guitar 2).mp3",
    ...
    synthFiles = [
        ...
        "Metroid II/Main Theme (Synth).mp3",
